...
namespace WebCinema.Controllers
{
    public class FilmProductionsController : Controller
    {
        ...
        // GET: FilmProductions
        public async Task<IActionResult> Index(string ProductionName, string FieldName, string OldFieldName, SortState SortOrder, int page = 1)
        {
            ...
            var model = new FilmProductionViewModel()
            {
                FilmProductions = productionsContext,
